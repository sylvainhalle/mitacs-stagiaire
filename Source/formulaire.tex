...
\tabitem{Professeur·e superviseur·e canadien·ne (exclure les titres)} & \auteur \\
\tabitem{Professeur·e superviseur·e canadien·ne — courriel (utilisé pour les projets Mitacs)} & \\
...
\begin{tabdonnees}
\tabitem{Date de début du stage} & \\
\tabitem{Nombre total de stages} & \\
\tabitem{Durée de chaque stage (mois)} & \\
\tabitem{Les unités de stage seront-elles consécutives?} & Si NON, remplissez l'{\color{darkred}Annexe C} \\
\tabitem{Montant de l'allocation par unité de stage
{\normalfont REMARQUE: le montant de l'allocation minimum est de 10~000~\$ par unité de stage pour Accélération}} & \\
\tabitem{Est-ce que la nouvelle ou le nouveau stagiaire remplace une ou un stagiaire déjà affecté au projet?} & \\
...
(S'il s'agit d'une chercheuse ou d'un chercheur au postdoctorat, indiquez la date d'obtention du doctorat)} & \\
\tabitem{Établissement d'enseignement fréquenté pendant le stage} & \\
\tabitem{Département (Nom officiel du département requis)} & \\
\tabitem{Téléphone principal} & \\
\tabtabitem{a. Autre téléphone ou téléphone cellulaire} & \\
\tabitem{Courriel permanent} & \\
\tabtabitem{a. Autre adresse courriel} & \\
\tabitem{Citoyenneté} & \\
\tabnoitem{Si Citoyenneté d'un autre pays, veuillez préciser} & \\
...
\tabsigitem{Signature:} & \includegraphics[width=1in]{emmett} & \textbf{Date:} xx-xx-xxxx\\
\end{tabsignatures}
...
\begin{tabsignatures}
\tabsigitem{Nom:} & \multicolumn{2}{l:}{Emmett Brown} \\
...
\tabsigitem{Signature:} &  & \textbf{Date:} xx-xx-xxxx\\
\end{tabsignatures}
